...
if (H3) {
    ...
    var csv_file1 = require("fs").readFileSync(`${path2}/H3_HA_clade_mutations.csv`, "utf8");
    var JSONfile1 = csvToJSON(csv_file1);
    var CSVfile1 = ConvertToCSV(JSONfile1);
...
if (H1) {
    ...
    var csv_file2 = require("fs").readFileSync(`${path2}/H1_HA_clade_mutations.csv`, "utf8");
