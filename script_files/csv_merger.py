...
NA = pd.read_csv ('{}/NA_mutation_results_final.csv'.format(cwd) , usecols= ['Sample','Mut_NA'], sep=',')
HA = pd.read_csv ('{}/HA_mutation_results_final.csv'.format(cwd) , sep=',')
MP = pd.read_csv ('{}/MP_mutation_results_final.csv'.format(cwd) , usecols= ['Sample','Mut_MP'], sep=',')
MP2 = pd.read_csv ('{}/MP2_mutation_results_final.csv'.format(cwd) , usecols= ['Sample','Mut_MP2'], sep=',')
